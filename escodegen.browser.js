  ...
  require.define('/escodegen.js', function (module, exports, __dirname, __filename) {
    (function () {
      ...
      function addIndent(stmt, indent) {
        ...
        if (sourceMap) {
          baseSourceNode = new SourceNode(stmt.line, 0, stmt.source || null, base, null);
        }
        return [
          baseSourceNode,
          stmt
      ...
      CodeGenerator.Statement = {
        ...
        ClassBody: function (stmt, flags) {
          ...
          withIndent(function (indent) {
            var i, iz;
            for (i = 0, iz = stmt.body.length; i < iz; ++i) {
              result.push(addIndent(that.generateExpression(stmt.body[i], Precedence.Sequence, E_TTT), indent));
              if (i + 1 < iz) {
                result.push(newline);
              }
            }
            ...
            if (stmt.specifiers.length === 0) {
              ...
              withIndent(function (indent) {
                ...
                for (i = 0, iz = stmt.specifiers.length; i < iz; ++i) {
                  result.push(addIndent(that.generateExpression(stmt.specifiers[i], Precedence.Sequence, E_TTT), indent));
                  if (i + 1 < iz) {
                    result.push(',' + newline);
                  }
                }
        ...
        ObjectExpression: function (expr, precedence, flags) {
          ...
          withIndent(function (indent) {
            ...
            result = [
              '{',
              newline,
              addIndent(fragment, indent)
            ];
            if (multiline) {
              result.push(',' + newline);
              for (i = 1, iz = expr.properties.length; i < iz; ++i) {
                result.push(addIndent(that.generateExpression(expr.properties[i], Precedence.Sequence, E_TTT), indent));
                if (i + 1 < iz) {
                  result.push(',' + newline);
                }
              }
